                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 2:  // common/BoxOffice/show
       {
         try {
           String show_id = in.read_string ();
           org.omg.CORBA.IntHolder showID = new org.omg.CORBA.IntHolder ();
           this.show (show_id, showID);
           out = $rh.createReply();
           out.write_long (showID.value);
         } catch (common.BoxOfficePackage.invalid_event $ex) {
           out = $rh.createExceptionReply ();
           common.BoxOfficePackage.invalid_eventHelper.write (out, $ex);
         }
       ...
       {
         common.BoxOfficePackage.eventsHolder all_shows = new common.BoxOfficePackage.eventsHolder ();
         this.allEvents (all_shows);
         out = $rh.createReply();
         common.BoxOfficePackage.eventsHelper.write (out, all_shows.value);
         break;
       }
