 ...
 implements common.BoxOfficeOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("canExchange", new java.lang.Integer (6));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 6:  // common/BoxOffice/canExchange
       {
         try {
           int customer_id = in.read_long ();
           String show_id = in.read_string ();
           int no_tickets = in.read_long ();
           boolean $result = false;
           $result = this.canExchange (customer_id, show_id, no_tickets);
           out = $rh.createReply();
       ...
       case 7:  // common/BoxOffice/shutdown
       {
         this.shutdown ();
         out = $rh.createReply();
         break;
